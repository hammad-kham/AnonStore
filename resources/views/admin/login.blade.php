...
<head>
  ...
  <title>Admin Login - NiceAdmin Bootstrap Template</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="{{ url('/') }}" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Pixarsart Studio</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('admin.login') }}" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      {{-- <p class="small mb-0">Don't have an account? <a href="{{ route('admin.register') }}">Create an account</a></p> --}}
                    </div>
                  </form>
