            ...
            <div class="row align-items-center">
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="banner-area__content">
                        ...
                        <a class="btn bg-primary" href="{{route('user.shop')}}">Shop Now</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2">
                    <div class="banner-area__img">
                        <img src="{{asset('frontend/assets/dist/images/banner.jpg')}}" alt="banner-img" class="img-fluid">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="brand-area">
                        <div class="brand-area-image">
                            <img src="{{asset('frontend/assets/dist/images/brand/01.png')}}" alt="Brand" class="img-fluid">
                        </div>
                        <div class="brand-area-image">
                            <img src="{{asset('frontend/assets/dist/images/brand/02.png')}}" alt="Brand" class="img-fluid">
                        </div>
                        <div class="brand-area-image">
                            <img src="{{asset('frontend/assets/dist/images/brand/03.png')}}" alt="Brand" class="img-fluid">
                        </div>
                        <div class="brand-area-image">
                            <img src="{{asset('frontend/assets/dist/images/brand/04.png')}}" alt="Brand" class="img-fluid">
                        </div>
                        <div class="brand-area-image">
                            <img src="{{asset('frontend/assets/dist/images/brand/02.png')}}" alt="Brand" class="img-fluid">
                        </div>
                        <div class="brand-area-image">
                            <img src="{{asset('frontend/assets/dist/images/brand/05.png')}}" alt="Brand" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="features-active">
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/05.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                    ...
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"> <img src="{{asset('frontend/assets/dist/images/product/04.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                    ...
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/01.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                    ...
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"> <img src="{{asset('frontend/assets/dist/images/product/02.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                    ...
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/03.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 ">
                        <div class="about-area-content-img">
                            <img src="{{asset('frontend/assets/dist/images/feature/medicine.jpg" alt="img')}}" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/06.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/07.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/08.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="product-item">
                        <div class="product-item-image">
                            <a href="product-details.html"><img src="{{asset('frontend/assets/dist/images/product/09.jpg')}}" alt="Product Name"
                                    class="img-fluid"></a>
                            <div class="cart-icon">
                                <a href="#"><i class="far fa-heart"></i></a>
                                <a href="#">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/tree dasher.jpg')}}" alt="images"></a>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/wool-shoe.jpg')}}" alt="images"> </a>
                        </div>
                        <div class="productcategory-text">
                            <a href="#">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/jumper.jpg')}}" alt="images"></a>
                        </div>
                        <div class="productcategory-text">
                            <a href="#">
                                <h6>Jumper</h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/iphone.jpg')}}" alt="images"></a>
                        </div>
                        <div class="productcategory-text">
                            <a href="#">
                                <h6>Apple</h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/drone.jpg')}}" alt="images"></a>
                        </div>
                        <div class="productcategory-text">
                            <a href="#">
                                <h6>Drone</h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/headphone.jpg')}}" alt="images"></a>
                        </div>
                        <div class="productcategory-text">
                            <a href="#">
                                <h6>Headphone</h6>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                    <div class="productcategory text-center">
                        <div class="productcategory-img">
                            <a href="#"><img src="{{asset('frontend/assets/dist/images/categorys/chosma.jpg')}}" alt="images"></a>
                        </div>
                        <div class="productcategory-text">
                            <a href="#">
                                <h6>Sunglass</h6>
