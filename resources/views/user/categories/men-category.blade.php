    ...
    <main>
        ...
        <section class="shop-page">
            <div class="container">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-card-image">
                                    <a href="{{ route('user.product.show', $product->id) }}">
                                        ...
                                        @endforeach
                                    @else
                                        <img src="{{ asset('storage/images/default-image.png') }}" alt="No Image"
                                            class="img-fluid">
                                    @endif
                                </a>
                            </div>
                            <div class="product-card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center price-stock-wrapper">
                                    ...
                                    @if ($product->stock > 0)
                                        <p class="product-card-stock mb-0 text-success">In Stock: {{ $product->stock }}
                                        </p>
                                    @else
                                ...
                                <div class="product-card-actions mt-3">
                                    <a href="#" class="btn btn-outline-secondary btn-outline-info "><i
                ...
                @empty
                    <div class="col-12">
                        <p>No products available in the Men's category.</p>
                    </div>
                @endforelse
            </div>
        </div>
   ...
   document.addEventListener('DOMContentLoaded', function () {
    document.querySelectorAll('.add-to-cart').forEach(button => {
        button.addEventListener('click', function (event) {
            ...
            console.log('Adding to cart:', { productId, userId }); // Log product ID and user ID
