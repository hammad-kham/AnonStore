...
<body>
                        ...
                        <div class="header-top-wrapper">
                            <div class="header-top-info">
                                <div class="email">
                                    ...
                                    <div class="text">
                                        <span>Hammadkhanhk152@mail.com</span>
                                    </div>
                                </div>
                                <div class="cta">
                                    <div class="icon">
            ...
            <div class="container">
                <div class="d-none d-lg-block">
                    <nav class="menu-area d-flex align-items-center">
                        <div class="logo">
                            <a href="#"><img src="{{ asset('frontend/assets/dist/images/logo/logo.png') }}"
                                    alt="logo" /></a>
                        </div>
                                            ...
                                            <ul class="dropdown-menu">
                                                @foreach ($shopCategories as $category)
                                                    <li class="dropdown-item px-2 py-1">
                                                        <a
                                                            href="{{ route('home', $category->id) }}">{{ $category->name }}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                        </li>
                        ...
                        <div class="menu-icon ml-auto">
                            <ul>
                                ...
                                <li>
                                    <a href="{{ route('user.cart.index') }}"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <li>
                                    <a href="{{ route('user.dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="row main-footer">
                <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                    <div class="main-footer-info">
                        <img src="{{ asset('frontend/assets/dist/images/logo/white.png') }}" alt="Logo"
                            class="img-fluid">
                        <p>
    ...
    <script src="{{ asset('frontend/assets/src/js/jquery.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/src/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/src/scss/vendors/plugin/js/slick.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/src/scss/vendors/plugin/js/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('frontend/assets/dist/main.js') }}"></script>
    <script>
        function openNav() {
